...
export type MutationConfig<Data, Error, Variables = void> = {
  ...
  onError?: MutationOptions<Data, Error, Variables>['onError']
  /**
   ...
   */
  onMutate?: MutationOptions<Data, Error, Variables>['onMutate']
  /** Function fires when mutation is either successfully fetched or encounters error */
  onSettled?: MutationOptions<Data, Error, Variables>['onSettled']
  /** Function fires when mutation is successful and will be passed the mutation's result */
  onSuccess?: MutationOptions<Data, Error, Variables>['onSuccess']
}
